...
| 3. **Традиционное Web-приложение**                       | 4    | [html](labs/3-Server/3-Server.md), [PDF](labs/3-Server/3-Server.pdf)                                         | -                                               | [link](https://classroom.github.com/a/eH9Gzt9m) | -                                               |
| 4. **AJAX**                                              | 3    | [html](labs/4-AJAX/4-AJAX.md), [PDF](labs/4-AJAX/4-AJAX.pdf)                                                 | -                                               | [link](https://classroom.github.com/a/iJmJJDvu) | -                                               |
| 5. **API**                                               | 3    | [html](labs/5-API/5-API.md), [PDF](labs/5-API/5-API.pdf)                                                     | -                                               | [link](https://classroom.github.com/a/CPhXK-v1) | -                                               |
| 6. **SPA**                                               | 4    | [html](labs/6-SPA/6-SPA.md), [PDF](labs/6-SPA/6-SPA.pdf)                                                     | -                                               | [link](https://classroom.github.com/a/RnapdxnO) | -                                               |
