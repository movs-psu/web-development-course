...
0. **Входной контроль:** работа с БД [[описание](./labs/0-Incoming-control.md), [PDF](./labs/0-Incoming-control.pdf), ~~[сдать](https://classroom.github.com/a/e4LKtqv0)~~]
1. **HTML, CSS:** вёрстка страницы проекта по эскизу [[описание](./labs/1-HTML-CSS.md), [PDF](./labs/1-HTML-CSS.pdf), [сдать](https://classroom.github.com/a/YXSSEEJu)]
